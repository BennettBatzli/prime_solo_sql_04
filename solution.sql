...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, 
transactions_completed, transactions_attempted, 
account_balance, user_id)
VALUES ('jim', 'atlanta', 4, 23, 1003.23, 9);

-- 9. The bank is losing money in Miami and Phoenix and needs to unload 
--low transaction customers: Delete users that reside in miami OR 
